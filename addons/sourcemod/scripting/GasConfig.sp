...
public OnPluginStart()
{
	...
	g_hSetupLimit = CreateConVar("l4d2_gasmenu_limit", "8", "Max number of gas setups to allow per map", FCVAR_PLUGIN, true, 0.0, true, 99.0);
	g_hLegitCan = CreateConVar("l4d2_gasmenu_legitcan", "1", "Whether or not to spawn cans that have correct movement properties", FCVAR_PLUGIN, true, 0.0, true, 1.0);
